...
void ImGui::ToggleButton(const char* str_id, bool* v, bool label)
{
    ...
    */
    ...
    if (ImGui::IsItemHovered())
    {
        if (*v)
        {
            col_bg = IM_COL32(55, 115, 184, 255);
            cir_bg = IM_COL32(55, 115, 184, 255);
        }
        else
        {
            col_bg = IM_COL32(55, 115, 184, 255);
    ...
    else
    {
        if (*v)
        {
            col_bg = IM_COL32(66, 149, 245, 255);
            cir_bg = IM_COL32(66, 149, 245, 255);
        }
        else
        {
