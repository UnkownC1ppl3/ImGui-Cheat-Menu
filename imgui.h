...
namespace ImGui
{
    ...
    IMGUI_API void          ToggleButton(const char* str_id, bool* v, bool label);                                   // ~ FontSize + style.FramePadding.y * 2 + style.ItemSpacing.y (distance in pixels between 2 consecutive lines of framed widgets)
